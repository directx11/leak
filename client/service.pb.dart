...
class Reply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reply', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GrpcServiceApi {
  $pb.RpcClient _client;
  GrpcServiceApi(this._client);

  $async.Future<Reply> getStream($pb.ClientContext? ctx, Empty request) =>
    _client.invoke<Reply>(ctx, 'GrpcService', 'GetStream', request, Reply())
  ;
}
